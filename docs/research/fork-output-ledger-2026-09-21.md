...
- **Votes:** the local House candidates contain 577 roll calls and 249,099 member-vote rows; the bounded local audit is complete. The confirmed selection defect is repaired and independently reviewed: source identity is enumerated independently of optional bill links, and the host now uses complete Senate menus. Unseen votes precede refreshes, each chamber receives overlap, and only successful vote reads replace their member rows. The retained log's 676 listing entries do not yet prove 99 unique omitted votes. Raw listing/body retention and whole-selection qualification remain required before publication or full-history scorecards. All 445 retained House voters join the qualified crosswalk, but eleven member/term-date joins remain unresolved. The capture driver is prepared for independent review. See `votes-qualification/`.
...
review. Its September 22, 2026, 02:56 UTC checkpoint distinguishes completed
