...
| T16 | `run-rollup-congress-bills` (retired, A1) | `congress_bills.parquet` | qualified at `9f861d50…` (2026-09-26): congress_bills holds 421,464 bills. BILLSTATUS lists 134,432 for the 108th–117th, and all are held but `117-hr-11`, one of 11 entries the reader refused in the 117th House archive. 54 list-era rows for reserved House numbers BILLSTATUS no longer lists are retained. All 513 bills the drift audit found missing in the 110th–113th are present, no identity of `8ab2a2cf…` is lost, and no key repeats. bill_committee_actions → congress_bills misses only the publisher's misprint `118-hr-14106`. Receipts: `congress-bills-backfill-2026-09-26/`, `join-gaps-2026-09-26/d/`. |
