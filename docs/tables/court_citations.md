...
**Coverage.** Not a range. The complete 2026-06-30 CourtListener citations export, copied field for field: 18,123,788 citations of 7,844,636 decisions, every (cluster_id, volume, reporter, page) unique as the publisher's schema requires, 456,590 of them in the U.S. Reports. All but 63 name a cluster present in the published court_opinion_clusters edition. Published on the fork as generation f1e2e523631ed4e291f85e4350c917bdabcb06bfa75ad47e12ac0e1d4c865415 (family court-citations) on 2026-09-22. *(measured 2026-09-22)*

**Data quality.** Citations are the publisher's, not re-derived from opinion text; a decision missing a citation here may still carry one in print. Reporter strings are the publisher's abbreviations and are not normalized. page is text because some reporters page with letters or asterisks.
