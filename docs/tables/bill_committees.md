...
**Coverage.** Sampled, and accumulating. Measured on one cold-start run of the 119th (receipt `d1-measured-run-2026-09-19/`): 18,956 bills rebuilt from the eight BILLSTATUS archives in 500 seconds, at 1,200 keyed and 616 keyless requests. It published 25,735 referral rows. Each run adds to what is published rather than replacing it, because a bill the publisher has not touched since the last run is skipped and its rows stand. Same scope as `bill_actions`: every committee and subcommittee named in the BILLSTATUS documents the bill-family rollup read. *(measured 2026-09-19)*
