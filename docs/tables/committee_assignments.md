...
**Coverage.** Sampled. None yet; the first run fills it. Today's seats: both chamber files are captured whole each run (441 House seats with 2,516 assignments and 100 senators with 450 seats on 2026-09-19), for the current Congress only, and each capture replaces its chamber's rows for that Congress; an earlier Congress keeps its last capture. *(measured 2026-09-19)*
