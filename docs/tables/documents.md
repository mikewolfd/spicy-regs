...
**Coverage.** True range, floored. Posted dates are stated from 1990-01-01 to the present rather than from the raw minimum, which is the year 0000. See the data-quality note: the raw ends are a publisher defect, not coverage. *(measured 2026-09-06)*
