...
**Coverage.** Window. The fork serves 28 releases from the complete House and Senate Appropriations feed captures of September 19 and September 22 UTC: all 25 current items plus three retained items that rotated out. The original window union passed every mapped-field comparison. A later scheduled generation refreshed timestamps and inferred bill links. Its bounded repair removes one false budget-year link and preserves four literal bill citations plus every other public value; public bytes and both MCP paths are checked separately. The newer capture metadata is not freshly raw-qualified. This covers the two captured feed windows, not all committees, earlier history or release-page bodies. See `press-release-qualification/` and `press-link-repair/` in the fork execution receipts. *(measured 2026-09-22)*
