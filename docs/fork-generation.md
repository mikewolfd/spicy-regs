...
- **T11:** current FR/CFR/Agenda remote bytes and counts pass. CFR traversal now
  ...
  volume XML shows the live parts wrong in titles 41, 43 and 14 vol 4 (9,250
  rows), and the fix reads each section's enclosing `PART` heading through
  SpicyDocs' annual scan (ledger, September 23 continuation; SpicyDocs
  consolidation plan A8).
